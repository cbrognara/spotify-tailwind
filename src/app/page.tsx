      ...
      <div className="flex flex-1">
        <aside className="w-72 bg-zinc-950 p-6">
          ...
          <nav className='mt-6 pt-10 border-t border-zinc-800 flex flex-col gap-3'>
            ...
            <a href='/' className='text-sm text-zinc-400 hover:text-zinc-100'>Karaoke</a>
            <a href='/' className='text-sm text-zinc-400 hover:text-zinc-100'>Soundtracks</a>
            <a href='/' className='text-sm text-zinc-400 hover:text-zinc-100'>Rock</a>
            <a href='/' className='text-sm text-zinc-400 hover:text-zinc-100'>Classic</a>
            <a href='/' className='text-sm text-zinc-400 hover:text-zinc-100'>Pop Culture</a>
          </nav>
        </aside>
        <main className="flex-1 p-6">
          ...
          <h2 className='font-semibold text-2xl mt-10'>Made for Camila Brognara</h2>

          <div className='grid grid-cols-8 gap-4 mt-4'>
            <a href='/' className='bg-white/5 group p-3 rounded-md flex flex-col gap-2 hover:bg-white/10 relative'>
            <Image src='/album.png' className='w-full' width={104} height={104} alt='Capa do album' />
            <strong className='font-semibold'>Daily Mix 1</strong>
            <span className='text-sm text-zinc-400'>Oomph, In Extremo, Imagine Dragons and more</span>
            <button className='w-12 h-12 flex items-center justify-center pl-1 rounded-full bg-green-400 text-black ml-auto mr-8 invisible group-hover:visible absolute -bottom-0.5 -right-1'> <Play/> </button>
            </a>
     ...
     <footer className="bg-zinc-800 border-t border-zinc-700 px-6 py-4 flex items-center justify-between">
      ...
      <Image src='/album.png' className='w-full' width={56} height={56} alt='Capa do album' />
        <div className='flex flex-col'>
          <strong className='font-normal'>Song 1 (feat. artist)</strong>
          <span className='text-xs text-zinc-400'>Oomph</span>
        </div>
      </div>
